...
///
/// Requires `can_request_monitor_events` capability - see [CapabilitiesNew].
///
/// Since JDWP version 1.6.
#[derive(Debug, JdwpReadable, JdwpWritable)]
...
///
/// It is also possible for the [AllThreads] command to return a thread before
...
///
/// Because of this timing, it is possible for [AllThreads] to return this
...
///
/// Requires `can_watch_field_access` capability - see [CapabilitiesNew].
#[derive(Debug, JdwpReadable, JdwpWritable)]
